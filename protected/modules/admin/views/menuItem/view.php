...
$this->breadcrumbs=array(
	'Menus'=>array('/admin/menu/admin'),
	'View: ' . $model->Menu->name=>array('/admin/menu/view','id'=>$model->Menu->id),
	'View: ' . $model->title,
);
...
<?php $this->widget('application.components.snapcms.SnapDetailView', array(
	'data'=>$model,
	'attributes'=>array(
		'id',
		'path',
