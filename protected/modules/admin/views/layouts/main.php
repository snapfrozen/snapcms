				...
				<?php $this->widget('zii.widgets.CMenu',array(
					...
					'items'=>array(
						...
						array(
							...
							'url'=>array('/admin/content/admin'), 
							'itemOptions'=>array('class'=>'dropdown'),
							'linkOptions'=>array('class'=>'dropdown-toggle','data-toggle'=>'dropdown'),
							'submenuOptions'=>array('class'=>'dropdown-menu'),
							//'template'=>'{menu}',
							'items'=>array(
								array('label'=>'Pages', 'url'=>array('/admin/content/admin')),
								array('label'=>'Create a Page', 'url'=>array('/admin/contentType/index')),
								array('label'=>'Menus', 'url'=>array('/admin/menu/admin')),
								//array('label'=>'Menu Items', 'url'=>array('/admin/menuItem/admin')),
								//array('label'=>'Groups', 'url'=>array('/admin/user/groups')),
							),
						),
						array(
						...
						//array('label'=>'Players', 'url'=>array('/admin/player/admin')),
					),
