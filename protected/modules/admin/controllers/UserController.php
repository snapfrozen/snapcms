...
class UserController extends DefaultController
{
	protected static $menuArray=array(
		array('label'=>'List Users', 'url'=>array('/admin/user/index'), 'access'=>'View User'),
		array('label'=>'Manage Users', 'url'=>array('/admin/user/admin'), 'access'=>'Update User'),
		array('label'=>'Manage Groups', 'url'=>array('/admin/user/groups'), 'access'=>'Manage User Groups'),
		//array('label'=>'User Group', 'url'=>array('/admin/user/permissions')),
	);
...
//			exit;
			...
			$this->redirect(array('/admin/user/groups'));
		}
