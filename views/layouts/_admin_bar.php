...
if ($app->user->checkAccess('Update Content')) :
    ...
    foreach ($conf as $setName => $options)
    {
        ...
        $fileBrowser = array_merge(array(
            'filebrowserBrowseUrl'      => $kcfinderUrl . '/browse.php?type=files',
            'filebrowserImageBrowseUrl' => $kcfinderUrl . '/browse.php?type=images',
            'filebrowserFlashBrowseUrl' => $kcfinderUrl . '/browse.php?type=flash',
            'filebrowserUploadUrl'      => $kcfinderUrl . '/upload.php?type=files',
            'filebrowserImageUploadUrl' => $kcfinderUrl . '/upload.php?type=images',
            'filebrowserFlashUploadUrl' => $kcfinderUrl . '/upload.php?type=flash'
        ), $options['config']);
